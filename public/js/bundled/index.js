...
/* eslint-disable*/ var _updateSettings = require("./updateSettings");
...
if (loginForm) loginForm.addEventListener("submit", (e)=>{
    ...
    console.log(email, password, "tester");
...
},{"./updateSettings":"l3cGY","@babel/polyfill":"dTCHC","./login":"7yHem","./stripe":"10tSC"}],"l3cGY":[function(require,module,exports) {
...
const login = async (email, password)=>{
    ...
    try {
        ...
        if (res.data.status == "success") {
            ...
            (0, _alerts.showAlert)("success", "loggend in succesfuly");
            window.setTimeout(()=>{
                location.assign("/");
            }, 1000);
        }
